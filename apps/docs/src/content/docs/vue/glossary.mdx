...
## Web Component
  ...
  Các thành phần Vue không phải là Web Components, nhưng defineCustomElement() có thể được sử dụng để tạo một <a href="/vue/glossary#custom-element" target="_blank"><span style="color: #00dc82">phần tử tùy chỉnh</span></a> từ một thành phần Vue. 
